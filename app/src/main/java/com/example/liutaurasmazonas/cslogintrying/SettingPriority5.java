...
//        databaseClients = FirebaseDatabase.getInstance().getReference("clients");
        ...
        bSettingsBlack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SettingPriority5.this, SettingsActivity.class));
            }
        });
        bEconCalBlack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SettingPriority5.this, WebViewActivity.class));
            }
        });
        bLiveRates.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SettingPriority5.this, sortingrates.class));
            }
        });
        bNewsBlack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(SettingPriority5.this, HomePageNews.class);
        ...
        bAddAProfile.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SettingPriority5.this, AddProfileActivity.class));
            }
        });
        ibSearch.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                startActivity(new Intent(SettingPriority5.this, GoogleSearchIntentActivity.class));
            }

        });


        ArrayAdapter<String> myAdaptor = new ArrayAdapter<String>(SettingPriority5.this,
        ...
        spinner5.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View view, int position, long row_id) {
                ...
                switch (position) {
                    case 1:
                        Intent intent1 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent1.putExtra("gggggurl1", gurl1);
                        startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent2.putExtra("gggggurl2", gurl2);
                        startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent3.putExtra("gggggurl3", gurl3);
                        startActivity(intent3);
                        break;
                    case 4:
                        Intent intent4 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent4.putExtra("gggggurl4", gurl4);
                        startActivity(intent4);
                        break;
                    case 5:
                        Intent intent5 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent5.putExtra("gggggurl5", gurl5);
                        startActivity(intent5);
                        break;
                    case 6:
                        Intent intent6 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent6.putExtra("gggggurl6", gurl6);
                        startActivity(intent6);
                        break;
                    case 7:
                        Intent intent7 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent7.putExtra("gggggurl7", gurl7);
                        startActivity(intent7);
                        break;
                    case 8:
                        Intent intent8 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent8.putExtra("gggggurl8", gurl8);
                        startActivity(intent8);
                        break;
                    case 9:
                        Intent intent9 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent9.putExtra("gggggurl9", gurl9);
                        startActivity(intent9);
                        break;
                    case 10:
                        Intent intent10 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent10.putExtra("gggggurl10", gurl10);
                        startActivity(intent10);
                        break;
                    case 11:
                        Intent intent11 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent11.putExtra("gggggurl11", gurl11);
                        startActivity(intent11);
                        break;
                    case 12:
                        Intent intent12 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent12.putExtra("gggggurl9", gurl12);
                        startActivity(intent12);
                        break;
                    case 13:
                        Intent intent13 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent13.putExtra("gggggurl9", gurl13);
                        startActivity(intent13);
                        break;
                    case 14:
                        Intent intent14 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent14.putExtra("gggggurl14", gurl14);
                        startActivity(intent14);
                        break;
                    case 15:
                        Intent intent15 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent15.putExtra("gggggurl15", gurl15);
                        startActivity(intent15);
                        break;
                    case 16:
                        Intent intent16 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent16.putExtra("gggggurl16", gurl16);
                        startActivity(intent16);
                        break;
                    case 17:
                        Intent intent17 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent17.putExtra("gggggurl17", gurl17);
                    ...
                    case 20:
                        ...
                        break;
                    case 21:
                        Intent intent21 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent21.putExtra("gggggurl21", gurl21);
                        startActivity(intent21);
                        break;
                    case 22:
                        Intent intent22 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent22.putExtra("gggggurl22", gurl22);
                        startActivity(intent22);
                        break;
                    case 23:
                        Intent intent23 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent23.putExtra("gggggurl23", gurl23);
                        startActivity(intent23);
                        break;
                    case 24:
                        Intent intent24 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent24.putExtra("gggggurl24", gurl24);
                        startActivity(intent24);
                        break;
                    case 25:
                        Intent intent25 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent25.putExtra("gggggurl25", gurl25);
                        startActivity(intent25);
                        break;
                    case 26:
                        Intent intent26 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent26.putExtra("gggggurl26", gurl26);
                        startActivity(intent26);
                        break;
                    case 27:
                        Intent intent27 = new Intent(SettingPriority5.this, HomePageNews.class);
                        intent27.putExtra("aaaaaurl1", aurl1);
                        startActivity(intent27);
                        break;
                    case 28:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent28 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent28.putExtra("aaaaaurl2", aurl2);
                        startActivity(intent28);
                        break;
                    case 29:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent29 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent29.putExtra("aaaaaurl3", aurl3);
                        startActivity(intent29);
                        break;
                    case 30:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent30 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent30.putExtra("aaaaaurl4", aurl4);
                        startActivity(intent30);
                        break;
                    case 31:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent31 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent31.putExtra("aaaaaurl5", aurl5);
                        startActivity(intent31);
                        break;
                    case 32:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent32 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent32.putExtra("aaaaaurl6", aurl6);
                        startActivity(intent32);
                        break;
                    case 33:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent33 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent33.putExtra("aaaaaurl7", aurl7);
                        startActivity(intent33);
                        break;
                    case 34:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent34 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent34.putExtra("aaaaaurl8", aurl8);
                        startActivity(intent34);
                        break;
                    case 35:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent35 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent35.putExtra("aaaaaurl9", aurl9);
                        startActivity(intent35);
                        break;
                    case 36:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent36 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent36.putExtra("aaaaaurl10", aurl10);
                        startActivity(intent36);
                        break;
                    case 37:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent37 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent37.putExtra("aaaaaurl11", aurl11);
                        startActivity(intent37);
                        break;
                    case 38:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent38 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent38.putExtra("aaaaaurl12", aurl12);
                        startActivity(intent38);
                        break;
                    case 39:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent39 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent39.putExtra("aaaaaurl13", aurl13);
                        startActivity(intent39);
                        break;
                    case 40:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent40 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent40.putExtra("aaaaaurl14", aurl14);
                        startActivity(intent40);
                        break;
                    case 41:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent41 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent41.putExtra("aaaaaurl15", aurl15);
                        startActivity(intent41);
                        break;
                    case 42:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent42 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent42.putExtra("aaaaaurl16", aurl16);
                        startActivity(intent42);
                        break;
                    case 43:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent43 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent43.putExtra("aaaaaurl17", aurl17);
                        startActivity(intent43);
                        break;
                    case 44:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent44 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent44.putExtra("aaaaaurl18", aurl18);
...
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent45 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent45.putExtra("aaaaaurl19", aurl19);
                        startActivity(intent45);
                        break;
                    case 46:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent46 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent46.putExtra("aaaaaurl20", aurl20);
                        startActivity(intent46);
                        break;
                    case 47:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent47 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent47.putExtra("aaaaaurl21", aurl21);
                        startActivity(intent47);
                        break;
                    case 48:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent48 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent48.putExtra("aaaaaurl22", aurl22);
                        startActivity(intent48);
                        break;
                    case 49:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent49 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent49.putExtra("aaaaaurl23", aurl23);
                        startActivity(intent49);
                        break;
                    case 50:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent50 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent50.putExtra("aaaaaurl24", aurl24);
                        startActivity(intent50);
                        break;
                    case 51:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent51 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent51.putExtra("aaaaaurl25", aurl25);
                        startActivity(intent51);
                        break;
                    case 52:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent52 = new Intent(SettingPriority5.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent52.putExtra("aaaaaurl26", aurl26);
...
//                        intent1.putExtra("key", key);
                        intent53.putExtra("rrrrrurl1", rurl1);
                        startActivity(intent53);
                        break;
                    case 54:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent54 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent54.putExtra("rrrrrurl2", rurl2);
                        startActivity(intent54);
                        break;
                    case 55:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent55 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent55.putExtra("rrrrrurl3", rurl3);
                        startActivity(intent55);
                        break;
                    case 56:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent56 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent56.putExtra("rrrrrurl4", rurl4);
                        startActivity(intent56);
                        break;
                    case 57:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent57 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent57.putExtra("rrrrrurl5", rurl5);
                        startActivity(intent57);
                        break;
                    case 58:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent58 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent58.putExtra("rrrrrurl6", rurl6);
                        startActivity(intent58);
                        break;
                    case 59:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent59 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent59.putExtra("rrrrrurl7", rurl7);
                        startActivity(intent59);
                        break;
                    case 60:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent60 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent60.putExtra("rrrrrurl8", rurl8);
                        startActivity(intent60);
                        break;
                    case 61:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent61 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent61.putExtra("rrrrrurl9", rurl9);
                        startActivity(intent61);
                        break;
                    case 62:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent62 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent62.putExtra("rrrrrurl10", rurl10);
                        startActivity(intent62);
                        break;
                    case 63:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent63 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent63.putExtra("rrrrrurl11", rurl11);
                        startActivity(intent63);
                        break;
                    case 64:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent64 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                    ...
                    case 65:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent65 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent65.putExtra("rrrrrurl13", rurl13);
                        startActivity(intent65);
                        break;
                    case 66:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent66 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent66.putExtra("rrrrrurl14", rurl14);
                        startActivity(intent66);
                        break;
                    case 67:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent67 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent67.putExtra("rrrrrurl15", rurl15);
                        startActivity(intent67);
                        break;
                    case 68:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent68 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent68.putExtra("rrrrrurl16", rurl16);
                        startActivity(intent68);
                        break;
                    case 69:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent69 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent69.putExtra("rrrrrurl17", rurl17);
                        startActivity(intent69);
                        break;
                    case 70:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent70 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent70.putExtra("rrrrrurl18", rurl18);
                        startActivity(intent70);
                        break;
                    case 71:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent71 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent71.putExtra("rrrrrurl19", rurl19);
                        startActivity(intent71);
                        break;
                    case 72:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent72 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent72.putExtra("rrrrrurl20", rurl20);
                        startActivity(intent72);
                        break;
                    case 73:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent73 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent73.putExtra("rrrrrurl21", rurl21);
                        startActivity(intent73);
                        break;
                    case 74:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent74 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent74.putExtra("rrrrrurl22", rurl22);
                        startActivity(intent74);
                        break;
                    case 75:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent75 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent75.putExtra("rrrrrurl23", rurl23);
                        startActivity(intent75);
                        break;
                    case 76:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent76 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent76.putExtra("rrrrrurl24", rurl24);
                        startActivity(intent76);
                        break;
                    case 77:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent77 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent77.putExtra("rrrrrurl25", rurl25);
                        startActivity(intent77);
                        break;
                    case 78:
                        //final String key = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl1);
                        Intent intent78 = new Intent(SettingPriority5.this, HomePageNews.class);
//                        intent1.putExtra("key", key);
                        intent78.putExtra("rrrrrurl26", rurl26);
