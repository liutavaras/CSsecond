...
public class SettingPriority6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bSettingsBlack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SettingPriority6.this, SettingsActivity.class));
            }
        });
        bEconCalBlack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SettingPriority6.this, WebViewActivity.class));
            }
        });
        bLiveRates.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SettingPriority6.this, sortingrates.class));
            }
        });
        ...
        ArrayAdapter<String> myAdaptor = new ArrayAdapter<String>(SettingPriority6.this,
            ...
            public void onItemSelected(AdapterView<?> arg0, View view, int position, long row_id) {
                ...
                switch (position) {
                    ...
                    case 26:
                        ...
                        break;
                    case 27:
                        Intent intent27 = new Intent(SettingPriority6.this, HomePageNews.class);
                        intent27.putExtra("aaaaaaurl1", aurl1);
                        startActivity(intent27);
                        break;
                    case 28:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent28 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent28.putExtra("aaaaaaurl2", aurl2);
                        startActivity(intent28);
                        break;
                    case 29:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent29 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent29.putExtra("aaaaaaurl3", aurl3);
                        startActivity(intent29);
                        break;
                    case 30:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent30 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent30.putExtra("aaaaaaurl4", aurl4);
                        startActivity(intent30);
                        break;
                    case 31:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent31 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent31.putExtra("aaaaaaurl5", aurl5);
                        startActivity(intent31);
                        break;
                    case 32:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent32 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent32.putExtra("aaaaaaurl6", aurl6);
                        startActivity(intent32);
                        break;
                    case 33:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent33 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent33.putExtra("aaaaaaurl7", aurl7);
                        startActivity(intent33);
                        break;
                    case 34:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent34 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent34.putExtra("aaaaaaurl8", aurl8);
                        startActivity(intent34);
                        break;
                    case 35:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent35 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent35.putExtra("aaaaaaurl9", aurl9);
                        startActivity(intent35);
                        break;
                    case 36:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent36 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent36.putExtra("aaaaaaurl10", aurl10);
                        startActivity(intent36);
                        break;
                    case 37:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent37 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent37.putExtra("aaaaaaurl11", aurl11);
                        startActivity(intent37);
                        break;
                    case 38:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent38 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent38.putExtra("aaaaaaurl12", aurl12);
                        startActivity(intent38);
                        break;
                    case 39:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent39 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent39.putExtra("aaaaaaurl13", aurl13);
                        startActivity(intent39);
                        break;
                    case 40:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent40 = new Intent(SettingPriority6.this, HomePageNews.class);
//                        intent4.putExtra("key", key);
                        intent40.putExtra("aaaaaaurl14", aurl14);
                        startActivity(intent40);
                        break;
                    case 41:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent41 = new Intent(SettingPriority6.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent41.putExtra("aaaaaaurl15", aurl15);
                        startActivity(intent41);
                        break;
                    case 42:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent42 = new Intent(SettingPriority6.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent42.putExtra("aaaaaaurl16", aurl16);
                        startActivity(intent42);
                        break;
                    case 43:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent43 = new Intent(SettingPriority6.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent43.putExtra("aaaaaaurl17", aurl17);
                        startActivity(intent43);
                        break;
                    case 44:
//                        String key4 = (String) getIntent().getExtras().get("key");
//                        databaseClients.child(key).child("image").setValue(gurl4);
                        Intent intent44 = new Intent(SettingPriority6.this, HomePageNews.class);
//                      intent41.putExtra("key", key);
                        intent44.putExtra("aaaaaaurl18", aurl18);
